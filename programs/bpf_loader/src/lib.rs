...
mod tests {
    ...
    fn test_bpf_loader_write() {
        ...
        let program_account = AccountNoData::new_ref(1, 0, &program_id);
    ...
    fn test_bpf_loader_invoke_main() {
        ...
        let parameter_account = AccountNoData::new_ref(1, 0, &program_id);
    ...
    fn test_bpf_loader_upgradeable_initialize_buffer() {
        ...
        let buffer_account = AccountNoData::new_ref(
            1,
            UpgradeableLoaderState::buffer_len(9).unwrap(),
            &bpf_loader_upgradeable::id(),
        );
        let authority_address = Pubkey::new_unique();
        let authority_account = AccountNoData::new_ref(
            1,
            UpgradeableLoaderState::buffer_len(9).unwrap(),
            &bpf_loader_upgradeable::id(),
        );
    ...
    fn test_bpf_loader_upgradeable_deploy_with_max_len() {
        ...
        let buffer_address = Pubkey::new_unique();
        let mut buffer_account = AccountNoData::new(
        ...
        buffer_account.data[UpgradeableLoaderState::buffer_data_offset().unwrap()..]
            .copy_from_slice(&elf);
        let program_account = AccountNoData::new(
            min_programdata_balance,
            UpgradeableLoaderState::program_len().unwrap(),
            &bpf_loader_upgradeable::id(),
        );
        let programdata_account = AccountNoData::new(
            1,
            UpgradeableLoaderState::programdata_len(elf.len()).unwrap(),
            &bpf_loader_upgradeable::id(),
        );
        ...
        bank.store_account(&program_keypair.pubkey(), &AccountNoData::default());
        bank.store_account(&programdata_address, &AccountNoData::default());
        ...
        bank.clear_signatures();
        bank.store_account(&buffer_address, &AccountNoData::default());
        bank.store_account(&program_keypair.pubkey(), &AccountNoData::default());
        bank.store_account(&programdata_address, &AccountNoData::default());
        let message = Message::new(
            &bpf_loader_upgradeable::deploy_with_max_program_len(
        ...
        bank.store_account(
            &mint_keypair.pubkey(),
            &AccountNoData::new(min_program_balance, 0, &system_program::id()),
        );
        bank.store_account(&buffer_address, &buffer_account);
        bank.store_account(&program_keypair.pubkey(), &AccountNoData::default());
        bank.store_account(&programdata_address, &AccountNoData::default());
        ...
        bank.store_account(
            &mint_keypair.pubkey(),
            &AccountNoData::new(1_000_000_000, 0, &system_program::id()),
        );
        ...
        bank.store_account(
            &mint_keypair.pubkey(),
            &AccountNoData::new(u64::MAX / 2, 0, &system_program::id()),
        );
        ...
        bank.clear_signatures();
        let mut modified_buffer_account = AccountNoData::new(
            min_programdata_balance,
            UpgradeableLoaderState::buffer_len(elf.len()).unwrap(),
            &bpf_loader_upgradeable::id(),
        );
    ...
    fn test_bpf_loader_upgradeable_upgrade() {
        ...
        let upgrade_authority_account = AccountNoData::new_ref(1, 0, &Pubkey::new_unique());
        ...
        fn get_accounts(
            ...
            let programdata_account = AccountNoData::new_ref(
                min_programdata_balance,
                UpgradeableLoaderState::programdata_len(elf_orig.len().max(elf_new.len())).unwrap(),
                &bpf_loader_upgradeable::id(),
            );
            programdata_account
                ...
                .unwrap();
            let program_account = AccountNoData::new_ref(
                min_program_balance,
                UpgradeableLoaderState::program_len().unwrap(),
                &bpf_loader_upgradeable::id(),
            );
            ...
            program_account
                ...
                .unwrap();
            let spill_account = AccountNoData::new_ref(0, 0, &Pubkey::new_unique());
    ...
    fn test_bpf_loader_upgradeable_set_upgrade_authority() {
        ...
        let new_upgrade_authority_account = AccountNoData::new_ref(1, 0, &Pubkey::new_unique());
        let program_address = Pubkey::new_unique();
        let (programdata_address, _) =
            Pubkey::find_program_address(&[program_address.as_ref()], &id());
        let programdata_account = AccountNoData::new_ref(
    ...
    fn test_bpf_loader_upgradeable_set_buffer_authority() {
        let instruction = bincode::serialize(&UpgradeableLoaderInstruction::SetAuthority).unwrap();
        let authority_address = Pubkey::new_unique();
        let authority_account = AccountNoData::new_ref(1, 0, &Pubkey::new_unique());
        let new_authority_address = Pubkey::new_unique();
        let new_authority_account = AccountNoData::new_ref(1, 0, &Pubkey::new_unique());
        let buffer_address = Pubkey::new_unique();
        let buffer_account = AccountNoData::new_ref(
            1,
