...
mod tests {
    ...
    fn create_config_account(keys: Vec<(Pubkey, bool)>) -> (Keypair, RefCell<AccountNoData>) {
        ...
        let config_account = RefCell::new(AccountNoData {
    ...
    fn test_process_store_with_additional_signers() {
        ...
        let signer0_account = RefCell::new(AccountNoData::default());
        let signer1_account = RefCell::new(AccountNoData::default());
        let accounts = vec![
    ...
    fn test_process_store_without_config_signer() {
        ...
        let signer0_account = RefCell::new(AccountNoData {
            owner: id(),
            ..AccountNoData::default()
        });
    ...
    fn test_config_updates() {
        ...
        let signer0_account = RefCell::new(AccountNoData::default());
        let signer1_account = RefCell::new(AccountNoData::default());
        let signer2_account = RefCell::new(AccountNoData::default());
        let keys = vec![
            (pubkey, false),
            (signer0_pubkey, true),
            (signer1_pubkey, true),
    ...
    fn test_config_bad_owner() {
        ...
        let signer0_pubkey = solana_sdk::pubkey::new_rand();
        let signer0_account = RefCell::new(AccountNoData::default());
        let config_account = RefCell::new(AccountNoData::default());
        let keys = vec![
            (from_pubkey, false),
            (signer0_pubkey, true),
            (config_pubkey, true),
