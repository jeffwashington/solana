...
pub fn create_account_with_authorized(
    ...
    let mut vote_account = AccountNoData::new(lamports, VoteState::size_of(), &id());
...
mod tests {
    ...
    fn test_initialize_vote_account() {
        ...
        let large_vote_account = AccountNoData::new_ref(100, 2 * VoteState::size_of(), &id());
    ...
    fn create_test_account() -> (Pubkey, RefCell<AccountNoData>) {
    ...
    fn create_test_account_with_authorized() -> (Pubkey, Pubkey, Pubkey, RefCell<AccountNoData>) {
        let vote_pubkey = solana_sdk::pubkey::new_rand();
    ...
    fn simulate_process_vote(
        vote_pubkey: &Pubkey,
        vote_account: &RefCell<AccountNoData>,
        vote: &Vote,
        slot_hashes: &[SlotHash],
        epoch: Epoch,
    ...
    fn test_vote_update_validator_identity() {
        ...
        let node_pubkey = solana_sdk::pubkey::new_rand();
        let node_account = RefCell::new(AccountNoData::default());
        let authorized_withdrawer_account = RefCell::new(AccountNoData::default());
    ...
    fn test_vote_signature() {
        ...
        let authorized_voter_account = RefCell::new(AccountNoData::default());
        let keyed_accounts = &[
        ...
        let withdrawer_account = RefCell::new(AccountNoData::default());
        let keyed_accounts = &[
            KeyedAccount::new(&vote_pubkey, false, &vote_account),
    ...
    fn test_vote_without_initialization() {
        let vote_pubkey = solana_sdk::pubkey::new_rand();
        let vote_account = RefCell::new(AccountNoData::new(100, VoteState::size_of(), &id()));
    ...
    fn test_vote_state_withdraw() {
        ...
        // all good
        let to_account = RefCell::new(AccountNoData::default());
