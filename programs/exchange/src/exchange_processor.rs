...
impl ExchangeProcessor {
    ...
    fn do_account_request(keyed_accounts: &[KeyedAccount]) -> Result<(), InstructionError> {
        ...
        Self::serialize(
            ...
            &mut Arc::make_mut(&mut keyed_accounts[NEW_ACCOUNT_INDEX]
                .try_account_ref_mut()?
                .data)[..],
        )
    }
    ...
    fn do_transfer_request(
            ...
            match state {
                ExchangeState::Account(mut from_account) => {
                    ...
                    Self::serialize(
                        ...
                        &mut Arc::make_mut(&mut keyed_accounts[FROM_ACCOUNT_INDEX]
                            .try_account_ref_mut()?
                            .data)[..],
                    )?;
                }
        ...
        Self::serialize(
            ...
            &mut Arc::make_mut(&mut keyed_accounts[TO_ACCOUNT_INDEX].try_account_ref_mut()?.data)[..],
        )
    }
    ...
    fn do_order_request(
        ...
        Self::serialize(
            ...
            &mut Arc::make_mut(&mut keyed_accounts[ORDER_INDEX].try_account_ref_mut()?.data)[..],
        )?;
        Self::serialize(
            &ExchangeState::Account(account),
            &mut Arc::make_mut(&mut keyed_accounts[ACCOUNT_INDEX].try_account_ref_mut()?.data)[..],
        )
    }
    ...
    fn do_swap_request(keyed_accounts: &[KeyedAccount]) -> Result<(), InstructionError> {
        ...
        if to_order.tokens == 0 {
            ...
            Self::serialize(
                ...
                &mut Arc::make_mut(&mut keyed_accounts[TO_ORDER_INDEX].try_account_ref_mut()?.data)[..],
            )?;
        } else {
            Self::serialize(
        ...
        if from_order.tokens == 0 {
            ...
            Self::serialize(
                &ExchangeState::Account(Self::trade_to_token_account(&from_order)),
                &mut Arc::make_mut(&mut keyed_accounts[FROM_ORDER_INDEX].try_account_ref_mut()?.data)[..],
            )?;
        } else {
            Self::serialize(
        ...
        Self::serialize(
            ...
            &mut Arc::make_mut(&mut keyed_accounts[PROFIT_ACCOUNT_INDEX]
                .try_account_ref_mut()?
                .data)[..],
        )
    }
