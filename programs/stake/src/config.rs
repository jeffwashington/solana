...
use solana_sdk::{
    account::AccountNoData, genesis_config::GenesisConfig, instruction::InstructionError,
...
impl Config {
    pub fn from(account: &AccountNoData) -> Option<Self> {
...
pub fn create_account(lamports: u64, config: &Config) -> AccountNoData {
