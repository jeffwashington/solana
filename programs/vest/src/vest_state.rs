...
mod test {
    ...
    #[test]
    fn test_serializer() {
        let mut a = AccountNoData::new(0, 512, &id());
    ...
    fn test_serializer_data_too_small() {
        let mut a = AccountNoData::new(0, 1, &id());
        let b = VestState::default();
        assert_eq!(
    ...
    fn test_schedule_after_renege() {
        ...
        let mut contract_account = AccountNoData::new(total_lamports, 512, &id());
        let mut payee_account = AccountNoData::new(0, 0, &system_program::id());
