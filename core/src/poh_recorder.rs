...
pub struct PohRecorder {
    ...
    record_us: u64,
    last_metric: Instant,
    sender_mixin: Sender<(Hash, Vec<Transaction>, Slot, Sender<Result<()>>)>,
...
impl PohRecorder {
    ...
    pub fn record1(
        ...
        //error!("Sending mixin");
        if self.sender_mixin.send((mixin, transactions, bank_slot, sender_result.clone())).is_err() {
    ...
    pub fn new_with_clear_signal(
        ...
        Receiver<(Hash, Vec<Transaction>, Slot, Sender<Result<()>>)>,
