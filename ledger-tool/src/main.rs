...
fn main() {
    ...
    match matches.subcommand() {
        ...
        ("good-bad", _) => {
            let good = PathBuf::from("/home/jwash/solana/DebugConsensus/mb/good.txt");
            let bad = PathBuf::from("/home/jwash/solana/DebugConsensus/mb/bad.txt");
            ...
            for result in &bad_results {
                ...
                if let Some(good_value) = good_result {
                    if good_value.1 != (result.1).1 || good_value.0 != (result.1).0 {
                        println!(
