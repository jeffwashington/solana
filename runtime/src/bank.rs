...
pub(crate) mod tests {
    ...
    use {
        ...
        crate::{
            ...
            accounts_db::{AccountsDbConfig, DEFAULT_ACCOUNTS_SHRINK_RATIO},
            accounts_index::{
                AccountIndex, AccountSecondaryIndexes, AccountsIndexConfig, ScanError,
                ACCOUNTS_INDEX_CONFIG_FOR_TESTING, ITER_BATCH_SIZE,
            },
            ancestors::Ancestors,
            genesis_utils::{
        ...
        let bank = Bank::new_with_paths_for_tests(
            ...
            Some(AccountsDbConfig {
                index: Some(AccountsIndexConfig {
                    rent_paying_accounts_by_partition: Some(rent_paying_accounts_by_partition),
