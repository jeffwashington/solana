...
use {
    crate::{
        ...
        ancestors::Ancestors,
        ancient_append_vecs::{
            get_ancient_append_vec_capacity, is_ancient, should_move_to_ancient_append_vec,
...
impl AccountsDb {
    ...
    pub fn notify_accounts_hash_calculated_complete(
        ...
        let value = *accounts_hash_complete_one_epoch_old;
        error!(
            "setting: {}, was: {}, slot: {}",
            one_epoch_old_slot, value, completed_slot
        );
    ...
    fn get_storages_to_move_to_ancient_append_vec(
        ...
        self.get_storages_for_slot(slot).and_then(|all_storages| {
            should_move_to_ancient_append_vec(&all_storages, current_ancient, slot)
                .then(|| all_storages)
        })
    }
