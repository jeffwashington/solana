...
impl AccountsDB {
    ...
    pub fn update_accounts_hash_with_index_option(
        ...
        if debug_verify {
            ...
            let msg = format!("update_accounts_hash_with_index_option mismatch. hashes: {}, {}; lamports: {}, {}; expected lamports: {:?}, using index: {}", hash, hash_other, total_lamports, total_lamports_other, expected_capitalization, use_index);
