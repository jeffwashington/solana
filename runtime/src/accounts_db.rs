        ...
        let scan_result: ScanStorageResult<(Pubkey, Hash), DashMapVersionHash> = self
            .scan_account_storage(
                ...
                |loaded_account: LoadedAccount| {
                    if slot == 156384102 {
                        use log::*;
                        error!("{}, {}, {:?}", loaded_account.pubkey(), loaded_account.rent_epoch(), (loaded_account.lamports(), loaded_account.data().len(), loaded_account.owner(), loaded_account.loaded_hash(), loaded_account.executable(), loaded_account.compute_hash(slot, loaded_account.pubkey())));
                    }
