...
impl AccountsDb {
    ...
    >(
        ...
        for (meta, account) in &accounts_and_meta_to_store {
            ...
            == Pubkey::from_str("Syt9g8PgKffA4SEiE9RFbyPvc3erR56EpJhy7FkCec3")
                .unwrap();
                                                if interesting {
                        ...
                        .filter_map(|pubkey| {
                                ...
                                self.accounts_index.get(pubkey, Some(ancestors), Some(slot))
                            {
                                ...
                                if !account_info.is_zero_lamport() {
                                    ...
                                    .and_then(
                                        |loaded_account| {
                                            let mut interesting =         pubkey == &Pubkey::from_str("Syt9g8PgKffA4SEiE9RFbyPvc3erR56EpJhy7FkCec3").unwrap();
