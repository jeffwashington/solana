...
impl AccountsDb {
        ...
        S: AppendVecScan,
    {
        ...
        let one_epoch_old_slot = max_slot_inclusive.saturating_sub(
            config
                .epoch_schedule
                .get_slots_in_epoch(config.epoch_schedule.get_epoch(max_slot_inclusive)),
        );
        ...
        let ancient_slots = snapshot_storages
            .iter_range(slot0..one_epoch_old_slot)
            .map(|(slot, _)| slot)
            .collect::<Vec<_>>();
                ...
                let (single_cached_slot, (start, mut end_exclusive)) = if chunk < ancient_slot_count
                {
                    ...
                    (false, {
                        ...
                        if chunk == 0 {
                            ...
                            // normal chunk in the middle or at the end_exclusive
