                ...
                .map(|pubkeys| {
                    ...
                    let result: Vec<Hash> = pubkeys
                        ...
                        .filter_map(|pubkey| {
                            ...
                            let mut interesting =         pubkey == &Pubkey::from_str("SsRCNdfanx8se9ZPWhTwePRVCasXTCmi8mZdEWffht7").unwrap();
    ...
    */
    ...
    fn maybe_rehash_rewrites(
        ...
        */
        ...
        /*
        if pubkey == &Pubkey::from_str("SsRCNdfanx8se9ZPWhTwePRVCasXTCmi8mZdEWffht7").unwrap() {
        }
        */
        assert!(!force_rehash);
