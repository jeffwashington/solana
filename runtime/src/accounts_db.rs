    ...
    >(
        ...
        for (meta, account) in &accounts_and_meta_to_store {
            ...
            == Pubkey::from_str("51ziC7nFBiY6vbBg4LWf6NeFywfntSHnXFuJtZMBoT6x")
                ...
                if (account.map(|x| x.lamports()).unwrap_or_default(), account.map(|x| x.rent_epoch()).unwrap_or_default()) == (3777545200, 275) {
                    // panic!("writing to");
                }
            }
        }
    ...
    */
    ...
    fn maybe_rehash_rewrites(
        ...
        */
        ...
        /*
        if pubkey == &Pubkey::from_str("51ziC7nFBiY6vbBg4LWf6NeFywfntSHnXFuJtZMBoT6x").unwrap() {
        }
        */
        assert!(!force_rehash);
