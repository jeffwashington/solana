                ...
                .map(|pubkeys| {
                    ...
                    let result: Vec<Hash> = pubkeys
                        ...
                        .filter_map(|pubkey| {
                            ...
                            let mut interesting =         pubkey == &Pubkey::from_str("3CKKAoVi94EnfX8QcVxEmk8CAvZTc6nAYzXp1WkSUofX 3akhnYGNjugsVGyPaXGBSzKo2KHJmtBTYUNavv9nZ1gT").unwrap();
    ...
    */
    ...
    fn maybe_rehash_rewrites(
        ...
        */
        ...
        /*
        if pubkey == &Pubkey::from_str("3CKKAoVi94EnfX8QcVxEmk8CAvZTc6nAYzXp1WkSUofX 3akhnYGNjugsVGyPaXGBSzKo2KHJmtBTYUNavv9nZ1gT").unwrap() {
        }
        */
        assert!(!force_rehash);
