        ...
        S: AppendVecScan,
    {
        ...
        (0..chunks)
            ...
            .map(|mut chunk| {
                ...
                let should_cache_hash_data = CalcAccountsHashConfig::get_should_cache_hash_data() || config.store_detailed_debug_info_on_failure;
                    ...
                    || config.store_detailed_debug_info_on_failure
                {
                    ...
                    if load_from_cache {
                        ...
                        if eligible_for_caching && cache_hash_data
                            .load(
                                &Path::new(&file_name),
                                &mut retval,
                                start_bin_index,
