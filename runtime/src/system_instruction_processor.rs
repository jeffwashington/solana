...
pub fn get_system_account_kind(account: &AccountNoData) -> Option<SystemAccountKind> {
...
mod tests {
    ...
    fn test_create_account_with_seed_missing_sig() {
        ...
        assert_eq!(*to_account.borrow(), AccountNoData::default());
    }
    ...
    fn test_get_system_account_kind_system_ok() {
        let system_account = AccountNoData::default();
        assert_eq!(
    ...
    fn test_get_system_account_kind_system_owner_nonzero_nonnonce_data_fail() {
        let other_data_account = AccountNoData::new_data(42, b"other", &Pubkey::default()).unwrap();
