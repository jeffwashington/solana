...
mod tests {
    ...
    fn test_empty_has_no_sigs() {
        ...
        assert_eq!(
            status_cache.get_status(&sig, &blockhash, &Ancestors::new()),
            None
        );
        assert_eq!(
            status_cache.get_status_any_blockhash(&sig, &Ancestors::new()),
            None
        );
    }
    ...
    fn test_clear_slot_signatures() {
        ...
        let mut ancestors0 = Ancestors::new();
        ancestors0.insert(0, 0);
        let mut ancestors1 = Ancestors::new();
