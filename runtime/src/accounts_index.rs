...
impl<T: 'static + Clone + IsCached + ZeroLamport> AccountsIndex<T> {
    ...
    fn update_secondary_indexes(
        ...
        // account hits zero lamports and is reset to AccountNoData::Default, then we skip
        ...
        // 2) When the fetch from storage occurs, it will return AccountNoData::Default
