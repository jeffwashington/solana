...
impl ActiveStats {
    ...
    fn update_and_log(&self, item: ActiveStatItem, modify_stat: impl Fn(&AtomicUsize) -> usize) {
        ...
        match item {
            ...
            ActiveStatItem::HashDeDup => datapoint_info!("accounts_db_active", ("hash_dedup", value, i64)),
            ActiveStatItem::HashMerkleTree => datapoint_info!("accounts_db_active", ("hash_merkle", value, i64)),
            ActiveStatItem::HashScan => datapoint_info!("accounts_db_active", ("hash_scan", value, i64)),
            ActiveStatItem::HashSort => datapoint_info!("accounts_db_active", ("hash_sort", value, i64)),
        };
    }
}
