use crate::index_entry::InitIfMatches;
            ...
            'outer: loop {
                ...
                for search in 0..search_end {
                    ...
                    if look_for_existing {
                        match elem.init_if_matches(index, v, k) {
                            InitIfMatches::SuccessfulInit => {
                            }
                            InitIfMatches::FoundDuplicate => {
